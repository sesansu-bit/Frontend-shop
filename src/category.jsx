...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["women"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }}className={styles["beauty"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["electronics"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["sports"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["perfume"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["luggage"]}>
...
<motion.div
         ...
         whileInView={{ y: 0, opacity: 1 }}
         transition={{ duration: 0.6 }}
         viewport={{ once: false, amount: 0.2 }} className={styles["arrow"]}>
